...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠉⠉⠛⠛⠛⠛⠋⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                        ...
                        IP  : {ip}
    """)
    tree = Tree(Fore.RED+"[Cracking Tools]")
...
def main():
    ...
    if cmd == "1":
        system("sudo python3 ./crack/wificrack.py")
    elif cmd == "2":
...
if __name__ == "__main__":
    ...
    if user == 0:
        ...
        print(Fore.RED+"[!] WARNING : By Moon need superuser privileges! Please run code by sudo!")